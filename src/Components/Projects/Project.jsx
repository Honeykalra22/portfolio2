...
const Project = () => {
    ...
    const mouse = () => {
        setDisplay('hidden')
        console.log('mouse over is running sucesfully');
        document.getElementById('sim').style.display = '';
        // document.getElementById('std').innerHTML = 'Hello baby'
            ...
            <div className=" flex flex-wrap justify-around items-center space-y-10">
                ...
                <div className=" flex flex-col items-center mx-2 lg:w-1/4">
                    ...
                    <a href="https://to-do-list-fn1d-hitesh-kalras-projects.vercel.app/" target="_blank">
                        <video src={to_do} autoPlay muted loop type="video/mp4" className="w-[450px] h-[300px] mb-5" ></video>
                    </a>
                    <p className="text-lg mb-2 capitalize text-center">
